...
//
//  Updated by Joel Fischer on 2025/09/15.
//
import Foundation
...
public class YMTGetDeviceName {
    ...
    enum DeviceCode: String {
        ...
        func deviceName() -> String {
            ...
            // MARK: iPod
            case .iPod1_1: return "iPod Touch 1st Generation"
            case .iPod2_1: return "iPod Touch 2nd Generation"
            case .iPod3_1: return "iPod Touch 3rd Generation"
            case .iPod4_1: return "iPod Touch 4th Generation"
            case .iPod5_1: return "iPod Touch 5th Generation"
            case .iPod7_1: return "iPod Touch 6th Generation"
            case .iPod9_1: return "iPod Touch 7th Generation"

            // MARK: iPhone
            case .iPhone1_1: return "iPhone 2G"
            ...
            case .iPhone5_1, .iPhone5_2: return "iPhone 5"
            case .iPhone5_3, .iPhone5_4: return "iPhone 5c"
            case .iPhone6_1, .iPhone6_2: return "iPhone 5s"
            ...
            case .iPhone8_4: return "iPhone SE 1st Generation"
            case .iPhone9_1, .iPhone9_3: return "iPhone 7"
            case .iPhone9_2, .iPhone9_4: return "iPhone 7 Plus"
            ...
            case .iPhone14_6: return "iPhone SE 3rd Generation"
            ...
            case .iPhone17_1: return "iPhone 16 Pro"
            case .iPhone17_2: return "iPhone 16 Pro Max"
            case .iPhone17_3: return "iPhone 16"
            case .iPhone17_4: return "iPhone 16 Plus"
            case .iPhone17_5: return "iPhone 16e"
            case .iPhone18_1: return "iPhone 17 Pro"
            case .iPhone18_2: return "iPhone 17 Pro Max"
            case .iPhone18_3: return "iPhone 17"
            case .iPhone18_4: return "iPhone Air"

            // MARK: iPad
            case .iPad1_1: return "iPad 1"
            case .iPad2_1, .iPad2_2, .iPad2_3, .iPad2_4: return "iPad 2"
            case .iPad2_5, .iPad2_6, .iPad2_7: return "iPad mini 1st Generation"
            case .iPad3_1, .iPad3_2, .iPad3_3: return "iPad 3"
            case .iPad3_4, .iPad3_5, .iPad3_6: return "iPad 4"
            case .iPad4_1, .iPad4_2, .iPad4_3: return "iPad Air 1st Generation"
            case .iPad4_4, .iPad4_5, .iPad4_6: return "iPad mini 2"
            case .iPad4_7, .iPad4_8, .iPad4_9: return "iPad mini 3"
            case .iPad5_1, .iPad5_2: return "iPad mini 4"
            case .iPad5_3, .iPad5_4: return "iPad Air 2"
            case .iPad6_3, .iPad6_4: return "iPad Pro 9.7-inch"
            case .iPad6_7, .iPad6_8: return "iPad Pro 12.9-inch"
            case .iPad6_11, .iPad6_12: return "iPad 5th Generation"
            case .iPad7_1, .iPad7_2: return "iPad Pro 12.9-inch 2nd Generation"
            case .iPad7_3, .iPad7_4: return "iPad Pro 10.5-inch"
            case .iPad7_5, .iPad7_6: return "iPad 6th Generation"
            case .iPad7_11, .iPad7_12: return "iPad 7th Generation"
            case .iPad8_1, .iPad8_2, .iPad8_3, .iPad8_4: return "iPad Pro 11-inch"
            case .iPad8_5, .iPad8_6, .iPad8_7, .iPad8_8: return "iPad Pro 12.9-inch 3rd Generation"
            case .iPad8_9, .iPad8_10: return "iPad Pro 11-inch 2nd Generation"
            case .iPad8_11, .iPad8_12: return "iPad Pro 12.9-inch 4th Generation"
            case .iPad11_1, .iPad11_2: return "iPad mini 5th Generation"
            case .iPad11_3, .iPad11_4: return "iPad Air 3rd Generation"
            case .iPad11_6, .iPad11_7: return "iPad 8th Generation"
            case .iPad12_1, .iPad12_2: return "iPad 9th generation"
            case .iPad13_1, .iPad13_2: return "iPad Air 4th Generation"
            case .iPad13_4, .iPad13_5, .iPad13_6, .iPad13_7: return "iPad Pro 11-inch 3rd Generation"
            case .iPad13_8, .iPad13_9, .iPad13_10, .iPad13_11: return "iPad Pro 12.9-inch 5th Generation"
            case .iPad13_16, .iPad13_17: return "iPad Air 5th Generation"
            case .iPad13_18, .iPad13_19: return "iPad 10th Gen"
            case .iPad14_1, .iPad14_2: return "iPad mini 6th Generation"
            case .iPad14_3, .iPad14_4: return "iPad Pro 11-inch 4th Gen"
            case .iPad14_5, .iPad14_6: return "iPad Pro 12.9-inch 6th Gen"
            case .iPad14_8, .iPad14_9: return "iPad Air 11-inch M2"
            case .iPad14_10, .iPad14_11: return "iPad Air 13-inch M2"
            case .iPad16_3, .iPad16_4: return "iPad Pro 11-inch M4"
            case .iPad16_5, .iPad16_6: return "iPad Pro 13-inch M4"
            }
        }
    }
